    ...
    <div class="page-content">
            ...
            <div class="ps-3">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb mb-0 p-0">
                        ...
                        <li class="breadcrumb-item"><a href="/dashboard/jenispublikasi">Data Jenis Publikasi</a>
                        </li>
        ...
        <div class="row">
            <div class="col-xl-12 mx-auto">
                <hr>
                <div class="card">
                    <form method="post" action="<?= base_url('/dashboard/jenispublikasi/update/' . $jenis->id_jenis) ?>">
                        <?= csrf_field(); ?>
                        ...
                        <div class="card-footer">
                            <div class="col-md-12">
                                <div class="form-group">
                                    <a href="<?= base_url('dashboard/jenispublikasi'); ?>" class="btn btn-danger"><i class="bx bx-arrow-back"></i> Kembali</a>
